package net.mcreator.miraculousuntoldtales;
...
@Mod("miraculous_untold_tales")
public class MiraculousUntoldTalesMod {
	public static final Logger LOGGER = LogManager.getLogger(MiraculousUntoldTalesMod.class);
	public static final String MODID = "miraculous_untold_tales";
